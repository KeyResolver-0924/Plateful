...
const MealTrackingScreen = ({ navigation }) => {
  ...
  const foods = [
    { id: 1, name: 'Cucumber', image: '🥒', category: 'Vegetables' },
    { id: 2, name: 'Tomato', image: '🍅', category: 'Vegetables' },
    { id: 3, name: 'Potato', image: '🥔', category: 'Vegetables' },
    { id: 4, name: 'Chicken', image: '🍗', category: 'Proteins' },
    { id: 5, name: 'Fish', image: '🐟', category: 'Proteins' },
    { id: 6, name: 'Rice', image: '🍚', category: 'Grains' },
    { id: 7, name: 'Apple', image: '🍎', category: 'Fruits' },
    { id: 8, name: 'Banana', image: '🍌', category: 'Fruits' },
    { id: 9, name: 'Milk', image: '🥛', category: 'Dairy' },
  ];
